...
public interface SongkickListInjectionComponent extends
    ...
    final class Initializer {
        ...
        public static ActivityInjectionComponent init(
                ...
                SongkickListActivity activity) {
            return DaggerSongkickListInjectionComponent
                    .builder()
                    .applicationInjectionComponent(applicationInjectionComponent)
                    .songkickListModule(new SongkickListModule())
                    .activityModule(
